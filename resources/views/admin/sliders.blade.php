          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tout les Sliders</h3>
              </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th>Num.</th>
                    <th>Photo</th>
                    <th>Description une</th>
                    <th>Description deux</th>
                    <th>Actions</th>
                  </tr>
                  </thead>
                  <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        @if ($slider->status != 0)
                        <a href="{{url('desactiver_slider/'.$slider->id)}}" class="btn btn-success">Désactiver</a>
                        @else
                        <a href="{{url('activer_slider/'.$slider->id)}}" class="btn btn-warning">Activer</a>
                        @endif
