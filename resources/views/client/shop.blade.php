            ...
            <div class="row justify-content-center">
                <div class="col-md-10 mb-5 text-center">
                    <ul class="product-category">
                        <li><a href="{{ url('/shop') }}" class="{{ request()->is('shop') ? 'active' : '' }}">Tout</a>
                        </li>
                        @foreach ($categories as $category)
                            <li><a href="{{ url('select_par_cat/' . $category->category_name) }}"
                                    class="{{ request()->is('select_par_cat/' . $category->category_name) ? 'active' : '' }}">
